...
| `Basic Configuration`      | <p>You can select the basic deployment configuration for your application on the <strong>Basic</strong> GUI section instead of configuring the YAML file.<br>Refer Basic Configuration section for more detail.<br></p>  |
| `Advanced (YAML)`          | <p>If you want to do additional configurations, then click <strong>Advanced (YAML)</strong> for modifications.<br>Refer Advanced (YAML) section for more detail.<br></p>                                                 |
...
| `timeRangesWithZone`:`timeZone`   | eg:- `"Asia/Kolkata"`,`"US/Pacific"`                                                                    | It use to specify the timeZone used. (It uses standard format. please refer [this](https://en.wikipedia.org/wiki/List\_of\_tz\_database\_time\_zones))                                                                     |
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/creating-application/deployment-template/deployment\_application\_metrics.jpg)

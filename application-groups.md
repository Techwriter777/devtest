...
Since every application comes with an option to restart its workloads (i.e., Pod, Deployment, ReplicaSet, Job), the same is true for application groups. Using application group, you can select the workloads of specific applications and restart them.
